...
public class EmailLoggingAspect {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(EmailLoggingAspect.class.getName());

    @Pointcut("@annotation(ivlev.ivlevback.aspect.annotation.EmailLogging)")
